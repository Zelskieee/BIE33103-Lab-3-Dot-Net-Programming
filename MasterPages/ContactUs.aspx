...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p class="form-instruction">Feel free to reach out to us using the contact form below:</p>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
         <label for="message">Message:</label>
                <asp:TextBox ID="message" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5" required></asp:TextBox>
     </div>

     <asp:Button ID="submitButton" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="submitForm_Click"></asp:Button>
</div>
