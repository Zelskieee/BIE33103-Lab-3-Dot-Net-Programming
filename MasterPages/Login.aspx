<%@ Page Title="Login" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Lab3.MasterPages.WebForm2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="login-container">
        ...
        <div class="status-container">
            <asp:Label ID="lblStatus" runat="server" style="font-weight: 700; color: #FF3300; font-size: medium" Visible="false"></asp:Label>
        </div>
        <p></p>
